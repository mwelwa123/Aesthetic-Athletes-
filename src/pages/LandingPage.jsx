    ...
    <div className="landing-page" style={{ minHeight:'100vh', overflowX:'hidden' }}>
      ...
      >
        ...
        >
          ...
          <div className="landing-hero-content afu">
            ...
            >
              Premium sports Jerseys, Runners and athletic gear.
              Quality products designed to help you achieve your goals.
            </p>
          ...
          {/* Auth card */}
          <div
            className="landing-auth afu"
            style={{
              animationDelay:'.12s'
            }}
          >
            <div
              className="landing-auth-card card"
              style={{
                position:'relative',
                overflow:'hidden'
              }}
      ...
      >
        <div style={{ maxWidth:1200, margin:'0 auto' }}>
          ...
          >
            Everything you need to dominate your sport
          </p>
          ...
          >
            {[
              {
                icon:<Zap size={22} color="var(--cyan)"/>,
                title:'Elite Gear',
                desc:'Pro-grade equipment used by champions worldwide'
              },
              {
                icon:<BarChart2 size={22} color="var(--cyan)"/>,
                title:'Track Orders',
                desc:'Real-time order tracking from purchase to delivery'
              },
              {
                icon:<Trophy size={22} color="var(--cyan)"/>,
                title:'Top Selection',
                desc:'Curated catalog of the best athletic products'
              },
              {
                icon:<Users size={22} color="var(--cyan)"/>,
                title:'Community',
                desc:'Join 12K+ athletes pushing limits every day'
              }
            ].map(f => (
              <div
                key={f.title}
      ...
      <section
        ...
        style={{
          ...
          zIndex:1,
          padding:'70px 48px',
          background:'linear-gradient(135deg,rgba(0,180,216,.07),rgba(21,101,192,.11))',
      ...
      >
        <div style={{ textAlign:'center' }}>
          ...
          >
            Join thousands of athletes who trust Aesthetic Athletes.
          </p>
